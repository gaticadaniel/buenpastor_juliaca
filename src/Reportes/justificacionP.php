  ...
  <table class="table table-bordered table-striped dt-responsive tablas1" style="width: 100%;">
    ...
    <tbody>
      <?php
        ...
        $justificacionP = $obJustificaciones->ctrMostrarAsistencias(2,$periodoId,$grupoId,$condicion,$fecha,$horario);
            
         foreach ($justificacionP as $key => $value){
