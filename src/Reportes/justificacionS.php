  ...
  <table class="table table-bordered table-striped dt-responsive tablas3" style="width: 100%;">
    ...
    <tbody>
      <?php
        ...
        $justificacionS = $obJustificaciones->ctrMostrarAsistencias(3,$periodoId,$grupoId,$condicion,$fecha,$horario);
            
         foreach ($justificacionS as $key => $value){
